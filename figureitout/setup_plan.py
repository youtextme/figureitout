...
PERMISSIONS = {
    ...
    "network_llm_local": "http://localhost:11435/v1 tireless-router",
    "network_llm_cloud": "ANTHROPIC_API_KEY or OPENAI_API_KEY when LLM_PROVIDER set",
...
SETUP_STEPS = [
    ...
    "Ensure tireless-router on :11435 (or set LLM_PROVIDER=anthropic|openai|mock)",
